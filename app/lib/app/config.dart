...
class Config {
  ...
  static const String packageNameAndroid = "com.saki.app";
  static const String packageNameiOS = "com.saki.app";
  static const String iosAppStoreId = "1048";
  static const String appName = "saki";
  static final String appVersion = "1.0.0";
  static const String companyName = "saki";
  static const String appOrCompanyUrl = "https://example.com";
  static final String initialCountry = 'AO'; // United States

  static const String serverUrl = String.fromEnvironment('PARSE_SERVER_URL', defaultValue: 'https://parseapi.back4app.com');
  static const String liveQueryUrl = String.fromEnvironment('PARSE_LIVE_QUERY_URL');
  static const String appId = String.fromEnvironment('PARSE_APP_ID');
  static const String clientKey = String.fromEnvironment('PARSE_CLIENT_KEY');
