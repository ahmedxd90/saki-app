...
class Setup {
  ...
  static const int zegoLiveStreamAppID = int.fromEnvironment('ZEGO_APP_ID', defaultValue: 0);
  static const String zegoLiveStreamAppSign = String.fromEnvironment('ZEGO_APP_SIGN');
  static const String zegoLiveStreamServerSecret = String.fromEnvironment('ZEGO_SERVER_SECRET');
  static const String zegoPushResourceID = String.fromEnvironment('ZEGO_PUSH_RESOURCE_ID');
