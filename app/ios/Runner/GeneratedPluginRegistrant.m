...
#if __has_include(<proximity_sensor/SwiftProximitySensorPlugin.h>)
#import <proximity_sensor/SwiftProximitySensorPlugin.h>
#else
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [SwiftProximitySensorPlugin registerWithRegistrar:[registry registrarForPlugin:@"SwiftProximitySensorPlugin"]];
